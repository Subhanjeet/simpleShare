...
export default function HomePage() {
  ...
  const handleStartUpload = async () => {
    ...
    try {
      ...
      formData.append("uploaderName", "A friend");
  ...
  return (
    <motion.div
      ...
      className="max-w-2xl mx-auto py-6 sm:py-10 space-y-8"
    >
      {/* Hero Header */}
      <div className="text-center space-y-3">
        ...
        <p className="text-base sm:text-lg text-slate-400 max-w-md mx-auto leading-relaxed">
          Fast file sharing without the extra steps.
        </p>
      </div>

      {/* Main Upload & Room Workflow */}
